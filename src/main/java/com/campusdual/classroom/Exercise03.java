...
public class Exercise03 {
    ...
    // Esto es una funcion, ya que devuelve un valor
    // TODO ↓: Tiene que devolver el siguiente mensaje:
    //  "Ups. No pudimos validar tus datos. Tu nombre de usuario no es "
    ...
    // TODO ↓: Tiene que comprobar si el usuario que recibe por parámetro es
    //  "Sebas" y su contraseña es "sebas01".
    //  Si es correcto, que muestre el mensaje de la función greetings()
    //  y si no que muestre el mensaje de la función error()
